...
def process_data():
    ...
    bucket = "airflow-projects-de"
    emp_data_path = f"gs://{bucket}/airflow-project-01/data/employee.csv"
    dept_data_path = f"gs://{bucket}/airflow-project-01/data/department.csv"
    output_path = f"gs://{bucket}/airflow-project-01 /output"
